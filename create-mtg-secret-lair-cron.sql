-- Create MTG Secret Lair Cron Job (uses consolidated post-mtg-card function)
-- Copy and paste this into Supabase SQL Editor

SELECT cron.schedule(
  'post-mtg-secret-lair',
  '0 */6 * * *',
  $$
  SELECT net.http_post(
    url := 'https://lxtkpwsxupzkxuhhmvvz.supabase.co/functions/v1/post-mtg-card?bot_type=secret-lair',
